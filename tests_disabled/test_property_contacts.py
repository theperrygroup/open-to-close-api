...
from open_to_close.property_contacts import PropertyContactsAPI
...
def test_list_property_contacts_success(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        params = {"role": "tenant"}
        result = property_contacts_api.list_property_contacts(
...
def test_create_property_contact_success(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_contacts_api.create_property_contact(
            property_id=property_id, contact_data=contact_data
        )
        mock_method.assert_called_once_with(
...
def test_retrieve_property_contact_success(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    contact_id = 1
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_contacts_api.retrieve_property_contact(
...
def test_update_property_contact_success(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_contacts_api.update_property_contact(
            property_id=property_id, contact_id=contact_id, contact_data=update_data
        )
        mock_method.assert_called_once_with(
            "PUT",
...
def test_delete_property_contact_success_204(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    contact_id = 1
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_contacts_api.delete_property_contact(
            property_id=property_id, contact_id=contact_id
        )
        mock_method.assert_called_once_with(
...
def test_delete_property_contact_success_json_response(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
...
def test_list_property_contacts_empty(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        ...
        mock_method.assert_called_once_with(
            "GET", f"/properties/{property_id}/contacts", params=None
        )
    assert result == []


def test_list_property_contacts_no_data_key(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
...
def test_create_property_contact_no_data_key(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
...
def test_retrieve_property_contact_no_data_key(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
...
def test_update_property_contact_no_data_key(
    property_contacts_api: PropertyContactsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_contacts_api.update_property_contact(
            property_id, contact_id, update_data
        )
        mock_method.assert_called_once_with(
            "PUT",
            f"/properties/{property_id}/contacts/{contact_id}",
