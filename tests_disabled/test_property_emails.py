...
def test_list_property_emails_success(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        params = {"folder": "sent"}
        result = property_emails_api.list_property_emails(
...
def test_create_property_email_success(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_emails_api.create_property_email(
            property_id=property_id, email_data=email_data
        )
        mock_method.assert_called_once_with(
...
def test_retrieve_property_email_success(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    email_id = 1
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_emails_api.retrieve_property_email(
            property_id=property_id, email_id=email_id
        )
        mock_method.assert_called_once_with(
...
def test_update_property_email_success(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    mock_response.json.return_value = {
        "data": {"id": 1, "subject": "Updated Welcome Email"}
    }
    property_id = 300
    email_id = 1
    update_data = {"subject": "Updated Welcome Email"}
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_emails_api.update_property_email(
            property_id=property_id, email_id=email_id, email_data=update_data
        )
        mock_method.assert_called_once_with(
            "PUT", f"/properties/{property_id}/emails/{email_id}", json_data=update_data
        )
    assert result == {"id": 1, "subject": "Updated Welcome Email"}


def test_delete_property_email_success_204(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    email_id = 1
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_emails_api.delete_property_email(
            property_id=property_id, email_id=email_id
        )
        mock_method.assert_called_once_with(
...
def test_delete_property_email_success_json_response(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
...
def test_list_property_emails_empty(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        ...
        mock_method.assert_called_once_with(
            "GET", f"/properties/{property_id}/emails", params=None
        )
    assert result == []


def test_list_property_emails_no_data_key(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
...
def test_create_property_email_no_data_key(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
...
def test_retrieve_property_email_no_data_key(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
...
def test_update_property_email_no_data_key(
    property_emails_api: PropertyEmailsAPI, client: OpenToCloseAPI
) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        result = property_emails_api.update_property_email(
            property_id, email_id, update_data
        )
        mock_method.assert_called_once_with(
            "PUT", f"/properties/{property_id}/emails/{email_id}", json_data=update_data
        )
