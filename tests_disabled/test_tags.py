...
from open_to_close.tags import TagsAPI
...
def test_update_tag_success(tags_api: TagsAPI, client: OpenToCloseAPI) -> None:
    ...
    with patch.object(client, "_request", return_value=mock_response) as mock_method:
        ...
        mock_method.assert_called_once_with(
            "PUT", f"/tags/{tag_id}", json_data=update_data
        )
...
def test_delete_tag_success_json_response(
    tags_api: TagsAPI, client: OpenToCloseAPI
) -> None:
