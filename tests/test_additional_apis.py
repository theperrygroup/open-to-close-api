...
class TestTagsAPI:
    ...
    def test_list_tags(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
        """Test listing tags."""
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_tags_with_params(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_tags_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_tag(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test creating a tag."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 1, "name": "VIP Client", "color": "#ff0000"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_tag_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_tag(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_tag_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_tag(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test updating a tag."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 123, "name": "Premium Client", "color": "#00ff00"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_tag(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
        """Test deleting a tag."""
...
class TestTeamsAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_teams(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
        """Test listing teams."""
        mock_request.return_value = mock_list_response
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_teams_with_params(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_team(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test creating a team."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 1, "name": "Sales Team", "description": "Primary sales team"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_team(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_team(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test updating a team."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 123, "name": "Marketing Team", "description": "Updated team"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_team(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
...
class TestUsersAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_users(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
        """Test listing users."""
        mock_request.return_value = mock_list_response
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_users_with_params(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_user(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_user(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test retrieving a user."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 123, "name": "John User", "email": "john@example.com"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_user(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test updating a user."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 123, "name": "Jane User", "role": "admin"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_user(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
...
class TestPropertyEmailsAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_emails(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_emails_with_params(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_emails_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_emails_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_emails_unexpected_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_email(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_email_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_email_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_email_unexpected_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_email(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_email_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_email(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_email_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_property_email(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
...
class TestPropertyNotesAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_notes(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_notes_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_notes_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_note(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_note_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_note_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_note(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_note_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_note(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_note_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_property_note(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
...
class TestPropertyDocumentsAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_documents(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_documents_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_documents_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_document(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_document_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_document_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_document(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_document_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_document(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        ...
        document = client.property_documents.update_property_document(1, 123, update_data)
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_document_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_property_document(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
...
class TestPropertyTasksAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_tasks(self, mock_request: Mock, client: OpenToCloseAPI, mock_list_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_tasks_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_property_tasks_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_task(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_task_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property_task_dict_response_no_data(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_task(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property_task_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_task(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test updating a property task."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 123, "title": "Updated Task", "status": "completed"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property_task_dict_response(self, mock_request: Mock, client: OpenToCloseAPI) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_property_task(self, mock_request: Mock, client: OpenToCloseAPI, mock_delete_response: Mock) -> None:
