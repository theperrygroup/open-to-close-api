...
class TestBaseClient:
    ...
    def test_handle_response_unknown_error(self, mock_request: Mock) -> None:
        ...
        with pytest.raises(OpenToCloseAPIError, match="Unexpected error: Unknown error"):
            client._handle_response(response)
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_request_with_leading_slash_endpoint(self, mock_session_request: Mock) -> None:
