...
from open_to_close_api.exceptions import NotFoundError, ValidationError, AuthenticationError
...
class TestAgentsAPI:
    ...
    def test_list_agents(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test listing agents."""
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_agent(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test creating an agent."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 1, "name": "John Agent", "email": "john@example.com"}
        
        agent_data = {"name": "John Agent", "email": "john@example.com", "phone": "+1234567890"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_agent(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_agent(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_agent(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
...
class TestContactsAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_contacts(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_contact(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
        """Test creating a contact."""
        mock_request.return_value = mock_response
        mock_response.json.return_value = {"id": 1, "name": "John Contact", "email": "john@example.com"}
        
        contact_data = {"name": "John Contact", "email": "john@example.com", "phone": "+1234567890"}
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_contact(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_contact(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_contact(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
...
class TestPropertiesAPI:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_list_properties(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_create_property(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_retrieve_property(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_update_property(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
    ...
    @patch('open_to_close_api.base_client.requests.Session.request')
    def test_delete_property(self, mock_request: Mock, client: OpenToCloseAPI, mock_response: Mock) -> None:
...
class TestClientIntegration:
    ...
    @patch('open_to_close_api.client.load_dotenv')
    def test_client_initialization_without_api_key_raises_error(self, mock_load_dotenv: Mock) -> None:
        """Test that client raises error without API key."""
        with pytest.raises(ValueError, match="API key not provided"):
            OpenToCloseAPI(api_key=None)
